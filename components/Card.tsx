          ...
          <div>
            {props.tags &&
              props.tags.map((item: any) => {
                if (item.name === "free") {
                  return (
                    <div key={item.name} className="text-xs text-green-500">
                      FREE
                    </div>
                  );
                } else if (item.name === "os") {
                  return (
                    <div key={item.name} className="text-xs text-gray-400">
                      OPEN SOURCE
                    </div>
                  );
                } else if (item.name === "freemium") {
                  return (
                    <div key={item.name} className="text-xs text-orange-500">
                      FREEMIUM
                    </div>
                  );
                } else if (item.name === "paid") {
                  return (
                    <div key={item.name} className="text-xs text-red-500">
                      PAID
                    </div>
                  );
                } else if (item.name === "rss") {
                  return (
                    <div key={item.name} className="text-xs text-yellow-500">
                      RSS
                    </div>
                  );
                } else if (item.name === "pwa") {
                  return (
                    <div key={item.name} className="text-xs text-purple-600">
                      PWA
                    </div>
                  );
                  ...
                  return (
                    <div key={item.name} className="text-xs text-blue-500">
                      TAILWIND
                    </div>
                  );
